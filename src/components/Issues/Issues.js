        ...
        <>
            <section>
                <div className="companyStatus issResolveCon">
                    ...
                    {
                        loading && <div className="issuesResol">
                            <div className="form">
                                <div>
                                    <div class="card">
                                        <div class="card-header ">
                                            <div >
                                                ...
                                                <input type="email" class="form-control w-100" id="exampleFormControlInput1" placeholder="add title of your issues" onChange={(e) => setTitle(e.target.value)} />
                                        ...
                                        <div class="card-body">
                                            <div className="">
                                                ...
                                                />
                                                <button className='btn text-white mt-4' style={{ backgroundColor: backDark }} onClick={(e) => log(e)}>Add issues</button>
                                            </div>
